...
public final class Executors {
   ...
   * Unless specified the default one is created from {@link
   * #createCachedThreadPoolExecutor(ThreadFactory)}.
   *
  ...
  /**
   * Creates an executor that uses the {@link
   ...
   *
   * @param threads The amount of threads to allow in the thread pool
   * @param threadFactory The thread factory to use.
   * @return An instance of this Executor
   * @since 1.2
   */
  ...
  /**
   * Creates an executor that uses the provided Java concurrent executor for the actual job
   * processing
   *
   * @param threadPool The java.util.Concurrent executor to use as thread pool
   * @return An instance of this Executor
   * @since 1.2
   */
