 ...
 * counter. <br>
 * E.g. providing the name <code>MyThread</code> will yield threads called <code>MyThread-<i>n</i></code>,
 * where <i>n</i> is the sequence counter for created threads. <br>
