 ...
 * This is what is called a disjoint union, meaning that the Either will never contain both types
 * only one of them. <br>
 ...
 * </blockquote>
 *
 * In contrast to {@link Try} and {@link Option} the {@link Either} cannot directly be used as a
 * collection (i.e iterate over it). <br>
 * This is due to that {@link Either} is unbiased as to which of {@link Left}, {@link Right} it
 * represents. <br>
 * To get access to the data represented by the {@link Either} you as a developer have to decide to
 * work with either the {@link Left} or {@link Right} side. <br>
 * <br>
 ...
 * The methods {@link #isLeft()} and {@link #isRight()} will help you decide which side is
 * represented. <br>
...
public interface Either<L, R> {
  ...
  /**
   * Applies <code>func_left</code> if this is a {@link Left} or <code>func_right</code> if this is
   * a {@link Right}
   *
   * @param <T> The type to return from <code>func_left/func_right</code>
   * @param func_left The function to apply in case this is a {@link Left}
   * @param func_right The function to apply in case this is a {@link Right}
