...
public final class OptionCompanion {
   ...
   * containing the provided value.<br>
   ...
   * </blockquote>
   *
   * @param <T> The type for the value this {@link Option} represents
   ...
   * </blockquote>
   *
   * @param <T> The type for the value this {@link Some} represents
   ...
   * </blockquote>
   *
   * @param <T> The type for the value this {@link None} represents
